...
unsigned long long ThreadHelper::GetCurrentID()
{
...
unsigned long long ThreadHelper::GetCurrentID(std::thread &t)
{
	// Get the string ID in an Integer form
	std::stringstream ss;
...
void ThreadHelper::SetThreadName(std::thread &t0, char* threadName)
{
...
void ThreadHelper::SetMainThreadName( char* threadName)
{
