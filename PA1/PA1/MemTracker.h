...
//
//   Modify main.cpp:
//      Add MEM_TRACKER_BEGIN to the first line of main
//          Has to be the first line of main 
//               To check static classes/allocations
//               Will actually all functions as well
...
#define MEM_TRACKER_START	MemTrace::out("--------------------------------\n"); \
...
#define MEM_TRACKER_BEGIN \
	...
	{ \
		 _StaticMem()	{ MEM_TRACKER_START } \
		~_StaticMem()	{ MEM_TRACKER_END } \
	} _StaticMemInst;
